...
![Introduction to Data Analytics](https://img.shields.io/badge/Introduction_to_Data-Analytics-SimpliLearn-4285F4?style=for-the-badge&logo=google&logoColor=white)
...
**Data Analyst @ IKEA (Toronto)** 🛋️

Supporting business stakeholders by translating operational data into actionable insights:
- 📈 Improving forecasting accuracy for inventory planning
- 🗑️ Driving waste reduction initiatives through data analysis
- 🔗 Designing end-to-end BI solutions integrating SQL, SharePoint, Power Query & Power BI
- 🎯 Enabling leadership teams to make timely, informed decisions

**Side Projects:** 🔬
- Building personal data projects to uncover insights on topics of interest
- Exploring predictive analytics and visualization techniques

---

## 🤝 Let's Collaborate!

I'm actively seeking opportunities in **BA / DA / BI roles** where data solves real business problems, improves efficiency, and drives strategic decision-making.

**Looking to collaborate on:**
- 🤖 Predictive data science modeling & ML algorithms
- 📊 Advanced BI implementations & automation
